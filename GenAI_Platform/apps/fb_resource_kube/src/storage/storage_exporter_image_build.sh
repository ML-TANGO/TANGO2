#!/bin/bash
IMAGE_REGI="192.168.1.150:30500"
...
if [[ -z "$IMAGE_INFO" ]]; then
    ...
    sudo nerdctl build --no-cache --tag $IMAGE_REGISTRY/$APP_NAME:0.1.4 -f $DOCKERFILE ..
    sudo nerdctl push $IMAGE_REGISTRY/$APP_NAME:0.1.4 --insecure-registry
