...
class AllocateWorkspaceInstanceError(CustomError):
    def __init__(self, message="Allocate the instance in workspace", location=Location):
        # 동작중인 Pod, 대기중인 Queue 가 없어야만 삭제 가능
        self.message = message
        self.location = location
        self.code = '006'
...
class WorkspaceStorageError(CustomError):
    def __init__(self, message="Workspace Storage Error", location=Location):
        self.message = message
        self.location = location
        self.code = '007'

class WorkspaceStoragePVCCreateError(CustomError):
    def __init__(self, message="Workspace Storage PVC Create Error", location=Location):
        self.message = message
        self.location = location
        self.code = '008'
        
class WorkspaceNamespaceCreateError(CustomError):
    def __init__(self, message="Workspace Namespace Create Error", location=Location):
        self.message = message
        self.location = location
        self.code = '009'
