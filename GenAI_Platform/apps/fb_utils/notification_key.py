...
WORKSPACE_INSTANCE_RESOURCE_MAIN_STORAGE_100_OVER    = "'{workspace_name}' 워크스페이스의 '메인 스토리지' 사용률이 100%에 도달하였습니다. 추가 요금이 발생될 수 있으니 불필요한 데이터를 삭제하세요."
WORKSPACE_INSTANCE_RESOURCE_DATA_STORAGE_OVER    = "'{workspace_name}' 워크스페이스의 '데이터 스토리지' 사용률이 80%를 초과하였습니다. 불필요한 데이터를 삭제하세요."
WORKSPACE_INSTANCE_RESOURCE_DATA_STORAGE_100_OVER    = "'{workspace_name}' 워크스페이스의 '메인 스토리지' 사용률이 100%에 도달하였습니다. 추가 요금이 발생될 수 있으니 불필요한 데이터를 삭제하세요."
# system -> admin
