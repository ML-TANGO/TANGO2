...
def create_image_pull(
    ...
    try:
        ...
        res = svc_new.create_image(
            ...
            image_type="pull", item={'url' : url}, user_id=cr.check_user_id()
        )
...
def create_image_build(
    ...
    try:
        ...
        res = svc_new.create_image_file(
            image_name=image_name, access=access, description=description, workspace_id_list=workspace_id_list,
            image_type="build", item={"file_":file_, "chunk_file_name":chunk_file_name, "end_of_file":end_of_file}, user_id=cr.check_user_id()
        )
        return res
    except CustomErrorList as ce:
        traceback.print_exc()
...
def create_image_tar(
    ...
    try:
        ...
        res = svc_new.create_image_file(
            image_name=image_name, access=access, description=description, workspace_id_list=workspace_id_list,
            image_type="tar", item={"file_":file_, "chunk_file_name":chunk_file_name, "end_of_file":end_of_file}, user_id=cr.check_user_id()
        )
        return res
    except CustomErrorList as ce:
        traceback.print_exc()
...
def create_image_commit(
    ...
    try:
        ...
        res = svc_new.create_image(
            image_name=image_name, access=access, description=description, workspace_id_list=workspace_id_list,
            image_type="commit", item={"training_tool_id" : training_tool_id, "message" : message}, user_id=cr.check_user_id()
        )
        return response(status=1, message="OK", result=res)
    except CustomErrorList as ce:
        traceback.print_exc()
...
def create_image_copy(
    ...
    try:
        ...
        res = svc_new.create_image(
            image_name=image_name, access=access, description=description, workspace_id_list=workspace_id_list,
            image_type="copy", item={"image_id" : image_id}, user_id=cr.check_user_id()
        )
        return response(status=1, message="OK", result=res)
    except CustomErrorList as ce:
        traceback.print_exc()
...
def create_image_ngc(
    ...
    try:
        ...
        res = svc_new.create_image(
            image_name=image_name, access=access, description=description, workspace_id_list=workspace_id_list,
            image_type="ngc", item={'url' : selected_image_url}, user_id=cr.check_user_id()
        )
        return response(status=1, message="OK", result=res)
    except CustomErrorList as ce:
        traceback.print_exc()
...
def create_image_tag(
    ...
    try:
        ...
        res = svc_new.create_image(
            image_name=image_name, access=access, description=description, workspace_id_list=workspace_id_list,
            image_type="tag", item={'selected_image_name' : selected_image_name, "node_ip" : node_ip}, user_id=cr.check_user_id()
        )
        return res
    except CustomErrorList as ce:
        traceback.print_exc()
...
def get_images(workspace_id: int=None):
    try:
        cr = CustomResource()
        res = svc.get_image_list(workspace_id, user_id=cr.check_user_id())
        return res
    except CustomErrorList as ce:
        traceback.print_exc()
        return ce.response()
...
def put(body: model.UpdateModel):
    try:
        ...
        res = svc.update_image(image_id=image_id, image_name=image_name, workspace_id_list=workspace_id_list,
                        access=access, description=description, user=cr.check_user())
        return res
    except CustomErrorList as ce:
        traceback.print_exc()
        return ce.response()
...
def delete(body: model.DeleteModel):
    ...
    try:
        ...
        res = svc.delete_image(delete_all_list=delete_all_list, delete_ws_list=delete_ws_list,
                        workspace_id=workspace_id, delete_user=cr.check_user_id())
        return res
    except CustomErrorList as ce:
        traceback.print_exc()
        return ce.response()
