...
import { Badge, StatusCard, Tooltip } from '@jonathan/ui-react';
        ...
        <div className={cx('flex-16')}>
          ...
          <div className={cx('between-cont')}>
            <div className={cx('label')}>
              ...
              <Badge
                label={
                  instance.cpu_available ? t('idle.label') : t('low.label')
                }
                size='sm'
                type={instance.cpu_available ? 'primary-2' : 'red'}
              />
              vCPU
            </div>
            <span className={cx('value')}>
          ...
          <div className={cx('between-cont')}>
            <div className={cx('label')}>
              ...
              <Badge
                label={
                  instance.ram_available ? t('idle.label') : t('low.label')
                }
                size='sm'
                type={instance.ram_available ? 'primary-2' : 'red'}
              />
              RAM
            </div>
            <span className={cx('value')}>
