...
import SubMenuItem from '../../SearchComponent/Item/SubMenuItem';
                ...
                >
                  <div className={cx('left')}>
                    <img
                      src={
                        isFolder
                          ? `/images/icon/00-ic-data-folder.svg`
                          : `/images/icon/file-dark.svg`
                      }
                      alt='file-icon'
                    />
                    <div className={cx('name')}>
                  ...
                  <div className={cx('user')}>{user ? user : owner}</div>
                </div>
              );
            })}
          </div>
