...
const useSSELog = (ragId, userName, setData, ragType) => {
  ...
  useEffect(() => {
    ...
    const connectSSE = () => {
      const url = `${API_HOST}rags/system-log/${ragId}?deployment_type=${ragType}`;
      const option = {
        headers: {
  ...
  }, [ragId, userName, setData, ragType, disconnectSSE]);
};

export default useSSELog;
