...
import style from './JobAdvancedList.module.scss';
        ...
        <div className={cx('info-box')}>
          ...
          <div className={cx('detail')}>
            ...
            <span className={cx('value')}>
              {dataset.length < 40 ? dataset : `${dataset.slice(0, 37)}...`}
            </span>
          </div>
          <div className={cx('detail', 'runcode')}>
            <span className={cx('type')}>실행 코드</span>
            <span className={cx('value')}>
              {runCode.length < 35 ? runCode : `${runCode.slice(0, 32)}...`}
            </span>
          </div>
...
export default JobAdvancedList;
