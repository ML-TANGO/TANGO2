module gitlab.suredatalab.kr/beymons/devices
...
require (
	...
	gitlab.suredatalab.kr/beymons/common v0.0.0-20251209062734-9d3cb52fe76e
	...
	gitlab.suredatalab.kr/services/notifications v1.2.3
