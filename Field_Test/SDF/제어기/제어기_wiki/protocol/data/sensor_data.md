...
- 계수기 (Counter)
  ...
  - 전송 주기 내에 집계된 카운트 횟수와 부팅 후 누적된 카운트 횟수를 전송한다.
...
- 우적 센서
  - 우적 센서에서 추가로 온/습도 센서 데이터를 취득할 수 있는 경우, 우적 센서의 다음 Address(우적 센서의 MODBUS address가 100번 이라면, 온/습도 센서의 MODBUS address는 101번)를 예약하고, 해당 Address의 포맷을 사용하여 전송한다
...
- relay : 모터 실제 동작 방향에 대한 정보
    - 0 : 내림 방향
    - 100 : 올림 방향
    - 255 : 정지
- relay_switch : 함체 물리적인 스위치 상태 정보
    - 0 : 내림 방향
    - 100 : 올림 방향
    - 255 : 정지
